          ...
          {/* left start */}
            <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="500" className="w-full sm:w-1/2">
              ...
              <ul className="flex items-center gap-3 xl:gap-5 mt-3">
                <li className={`text-[10px] sm:text-[10px] md:text-xs lg:text-sm xl:text-base 2xl:text-lg px-4 py-2 xl:px-6 xl:py-2 ${color ? 'bg-red-500' : 'bg-yellow-500'} text-white font-bold rounded-md`}>
                  My Resume
                </li>
                <Link to="/contact">
                <li className={`text-[10px] sm:text-[10px] md:text-xs lg:text-sm xl:text-base 2xl:text-lg px-4 py-2 xl:px-6 xl:py-2 rounded-md ${color ? 'bg-white shadow-inner shadow-slate-300 text-black hover:shadow-red-500 hover:duration-500 hover:shadow-sm' : 'bg-black text-white hover:shadow-yellow-500 duration-300 shadow-sm shadow-white'}  font-bold`}>Hire Me
                </li>
                </Link>
              </ul>
              {/* top item */}
              ...
              <div className="block sm:hidden mt-3 h-full">
                <ul className="flex gap-2 items-center">
                  ...
                  <li className={`text-sm rounded-full  ${color ? 'bg-white shadow-inner shadow-slate-300 text-black hover:text-red-500' : 'bg-black shadow-inner shadow-slate-800 text-white hover:text-yellow-500'} w-6 h-6 flex justify-center items-center`}>
