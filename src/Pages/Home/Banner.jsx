          ...
          {/* left start */}
            <div data-aos="fade-right" data-aos-easing="linear" data-aos-duration="500" className="w-full sm:w-1/2">
              ...
              <ul className="flex items-center gap-3 xl:gap-5 mt-3">
                <li className={`text-[10px] sm:text-[10px] md:text-xs lg:text-sm xl:text-base 2xl:text-lg px-4 py-2 xl:px-6 xl:py-2 ${color ? 'bg-red-500' : 'bg-yellow-500'} text-white font-bold rounded-md flex items-center gap-1`}>
                  My Resume
